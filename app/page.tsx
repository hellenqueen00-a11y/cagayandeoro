...
const destinationGroups: Array<{
  ...
  },
  {
    ...
    destinations: [
      { title: "커뮤니얼 랜치", image: "/communal-ranch.jpg", alt: "초록 능선이 펼쳐진 커뮤니얼 랜치", copy: "뉴질랜드를 닮은 초록 언덕과 작은 호수가 펼쳐지는 목장. 승마와 드론 촬영, 자연 속 휴식에 어울리며 시내에서 차로 약 2시간 소요됩니다.", tags: ["승마", "포토 스폿", "자연 체험"] },
      { title: "클라베리아", image: "/claveria-highlands.png", alt: "겹겹이 이어진 산과 계곡을 바라보는 클라베리아 고원 전망대", copy: "해발 600~950m의 청정 고원. 서늘한 기후와 꽃밭, 발라투칸 산맥의 풍경이 특별한 힐링 목적지이며 시내에서 차로 약 2시간 소요됩니다.", tags: ["고원", "트레킹", "생태 여행"] },
    ],
  },
  {
    number: "04",
              ...
              <div className="hotel-image">
                {hotel.secondaryImage ? (
                  <div className={`hotel-image-pair${hotel.thirdImage ? " hotel-image-trio" : ""}`}>
                    <div><Image src={hotel.image} alt={`${hotel.name} ${hotel.thirdImage ? "해변 다이닝 전경" : "수영장"}`} fill sizes="(max-width: 800px) 50vw, 25vw" /></div>
